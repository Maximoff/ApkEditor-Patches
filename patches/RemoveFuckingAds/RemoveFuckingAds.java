...
public class RemoveFuckingAds {
	...
	private String[] smaliPatterns = {
		...
		"\\.method public(.+?)attachInfo\\(Landroid/content/Context;Landroid/content/pm/ProviderInfo;\\)V([\\s\\S]+?)\"com\\.google\\.android\\.gms\\.ads\\.APPLICATION_ID\"([\\s\\S]+?)\\.end method"
	};
	private String[] smaliReplacement = {
		...
		".method public$1attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V\n\t.registers 4\n\n\t#Remove-Fucking-Ads\n\treturn-void\n.end method"
	};
